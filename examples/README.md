# Text Readability Score API - Examples

This folder contains example code for using the Text Readability Score API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/readabilityscore',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/readabilityscore");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/readabilityscore](https://docs.apiverve.com/ref/readabilityscore)
