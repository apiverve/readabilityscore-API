# Text Readability Score Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:readabilityscore-api:1.1.12'
}
```
...
TextReadabilityScoreAPIClient client = new TextReadabilityScoreAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/readabilityscore](https://docs.apiverve.com/ref/readabilityscore)
...
- **Documentation:** [https://docs.apiverve.com/ref/readabilityscore](https://docs.apiverve.com/ref/readabilityscore)
- **Issues:** [GitHub Issues](https://github.com/apiverve/readabilityscore-api/issues)
